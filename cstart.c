...
#if ( defined _REGTC26X_H || defined _REGTC26XB_H || defined _REGTC39X_H  )
#if __XC800_INIT
...
#if ( defined _REGTC39X_H || defined _REGUSERDEF162_H )
#define __CLR_BHALT             0;
#endif

#if ( defined _REGUSERDEF16X_H || defined _REGUSERDEF162_H || defined _REGTC27X_H || defined _REGTC27XB_H || defined _REGTC27XC_H || defined _REGTC27XD_H || defined _REGTC26X_H || defined _REGTC26XB_H || defined _REGTC29X_H || defined _REGTC29XB_H || defined _REGTC39X_H )
...
/* c init semaphores */
#if ( defined _REGTC27X_H || defined _REGTC27XB_H || defined _REGTC27XC_H || defined _REGTC27XD_H || defined _REGTC29X_H || defined _REGTC29XB_H || defined _REGTC39X_H )
...
#endif
#if __STADD_INIT_TC3 && ( defined _REGTC39X_H || defined _REGUSERDEF162_H )
        /*
...
#endif
#if __STADD_INIT_TC4 && ( defined _REGTC39X_H || defined _REGUSERDEF162_H )
        /*
...
#endif
#if __STADD_INIT_TC5 && ( defined _REGTC39X_H || defined _REGUSERDEF162_H )
        /*
...
#endif
#if __HALT_INIT_TC3 && ( defined _REGTC39X_H || defined _REGUSERDEF162_H ) && __HALT_VALUE_TC3==2
#define __TC3_END_C_INIT_MASK   0
#else
#define __TC3_END_C_INIT_MASK   1<<3
#endif
#if __HALT_INIT_TC4 && ( defined _REGTC39X_H || defined _REGUSERDEF162_H ) && __HALT_VALUE_TC4==2
#define __TC4_END_C_INIT_MASK   0
#else
#define __TC4_END_C_INIT_MASK   1<<4
#endif
#if __HALT_INIT_TC5 && ( defined _REGTC39X_H || defined _REGUSERDEF162_H ) && __HALT_VALUE_TC5==2
...
#endif
#endif
#if __HALT_INIT_TC3 && ( defined _REGTC39X_H || defined _REGUSERDEF162_H )
        CPU3_SYSCON.B.BHALT=__CLR_BHALT;
#endif
#if __HALT_INIT_TC4 && ( defined _REGTC39X_H || defined _REGUSERDEF162_H )
        CPU4_SYSCON.B.BHALT=__CLR_BHALT;
#endif
#if __HALT_INIT_TC5 && ( defined _REGTC39X_H || defined _REGUSERDEF162_H )
...
#define __PDIV          SCU_SYSPLLCON0.B.PDIV
        ...
        || defined _REGTC26X_H  || defined _REGTC26XB_H || defined _REGTC29X_H  || defined _REGTC29XB_H || defined _REGTC39X_H || defined _REGUSERDEF162_H )
#if ( defined _REGTC21X_H || defined _REGTC22X_H || defined _REGTC23X_ADAS_H || defined _REGTC23X_H || defined _REGTC27X_H || defined _REGTC27XB_H || defined _REGTC27XC_H || defined _REGTC27XD_H || defined _REGTC26X_H || defined _REGTC26XB_H || defined _REGTC29X_H || defined _REGTC29XB_H || defined _REGTC39X_H || defined _REGUSERDEF162_H )
...
{
        /*
         *      Set __PMSWCRx.SCRSTEN so SCRSTREQ can be updated
...
static void localmemcpy(unsigned int *dest, unsigned int *src, int len)
{
        for (int i = 0; i < len; i++)
        {
                dest[i] = src[i];
...
static void _xc800_init ( void )
{
        if ( scr_init() )                                       /* Only download when allowed */
        {
                ...
                qspi2_end();
#else
                localmemcpy( __XRAM_ADDR, _lc_ub__rodata_xc800init, LENGTH/sizeof(int) );
#endif
        }
}
