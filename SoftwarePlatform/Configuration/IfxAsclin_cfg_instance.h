...
#define IFXASCLIN_INSTANCE_MODULE_ASCLIN0_USED  1
#define IFXASCLIN_INSTANCE_MODULE_ASCLIN1_USED  0
#define IFXASCLIN_INSTANCE_MODULE_OPTIONS_USED  1
#define IFXASCLIN_INSTANCE_MODULE_MIN  IFXASCLIN_INSTANCE_MODULE_ASCLIN0
#define IFXASCLIN_INSTANCE_MODULE_MAX  IFXASCLIN_INSTANCE_MODULE_ASCLIN0
